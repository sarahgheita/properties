...
export const SYSTEM_INSTRUCTION = `You are the assistant for ${SITE_NAME}, a real-estate marketplace in Egypt run by a single agent.
...
- Keep answers short and friendly. Reply in the same language the user writes in (Arabic or English).
...
export async function callGemini(history: ChatTurn[]): Promise<GeminiReply> {
